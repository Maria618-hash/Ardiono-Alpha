...
// {
// }
// ESP32SJA1000Class::ESP32SJA1000Class(uint32_t baseAddress) 
//   : CANControllerClass(), _base(baseAddress) {
// }
...
//     case (long)250E3:
//       modifyRegister(REG_BTR1, 0x0f, 0x1c);
//       modifyRegister(REG_BTR0, 0x3f, 4);
//       break;
...
//   volatile uint32_t* reg = (volatile uint32_t*)(_base + address * 4);
