...
#define VARIANT_DIGITAL_PIN_MAP  {{.io_port = 0, .bit_pos = 0, .pwm_num = 0, .pwm_cmp_num = PWM_P_PTC1}, \
	{.io_port = 0, .bit_pos = 1, .pwm_num = 1, .pwm_cmp_num = PWM_P_PTC2}, \
	{.io_port = 0, .bit_pos = 2, .pwm_num = 2, .pwm_cmp_num = PWM_P_PTC3}, \
	{.io_port = 0, .bit_pos = 3, .pwm_num = 3,  .pwm_cmp_num = PWM_P_PTC4}, \
	{.io_port = 0, .bit_pos = 4, .pwm_num = 4,  .pwm_cmp_num = PWM1}, \
	{.io_port = 0, .bit_pos = 5, .pwm_num = 5,  .pwm_cmp_num = PWM2}, \
	{.io_port = 0, .bit_pos = 6, .pwm_num = 0,  .pwm_cmp_num = PWM_P_PTC1}, \
	{.io_port = 0, .bit_pos = 7, .pwm_num = 1, .pwm_cmp_num = PWM_P_PTC2}, \
	{.io_port = 0, .bit_pos = 8, .pwm_num = 2,  .pwm_cmp_num = PWM_P_PTC3}, \
	{.io_port = 0, .bit_pos = 9,  .pwm_num = 3,  .pwm_cmp_num = PWM_P_PTC4}, \
	{.io_port = 0, .bit_pos = 10,  .pwm_num = 4,  .pwm_cmp_num = PWM1}, \
	{.io_port = 0, .bit_pos = 11,  .pwm_num = 5, .pwm_cmp_num  = PWM2}, \
	{.io_port = 0, .bit_pos = 12,  .pwm_num = 0, .pwm_cmp_num = PWM_P_PTC1}, \
	{.io_port = 0, .bit_pos = 13,  .pwm_num = 0xFF, .pwm_cmp_num = PWM_P_PTC2}, \
